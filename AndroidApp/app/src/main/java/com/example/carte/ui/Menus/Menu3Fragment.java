...
public class Menu3Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        listeEntree = getResources().getStringArray(R.array.menu3entrees);
        entreeDrawable = getResources().getStringArray(R.array.menu3entreesDrawable);
        ...
        listePlats = getResources().getStringArray(R.array.menu3plats);
        platDrawable = getResources().getStringArray(R.array.menu3platsDrawable);
        ...
        listeDessert = getResources().getStringArray(R.array.menu3desserts);
        dessertDrawable = getResources().getStringArray(R.array.menu3dessertsDrawable);
